...
void menu()
{
    ...
    cout << "3. Generar diagrama de arbol." << endl;
    cout << "4. Salir." << endl;
}
...
int main()
{
    ...
    while (opcion != 4)
    {
        ...
        else if (opcion == 2)
        {
            ...
            pair<vector<double>, vector<double>> datos = leerArchivo(nombreArchivo);
            vector<double> numeros1 = datos.first;
            vector<double> numeros2 = datos.second;
